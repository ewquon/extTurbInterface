...
//                  numVelPtsTower[iTurb] = cDriver_Output_to_FAST[iTurb].u_Len - numBlades[iTurb]*numVelPtsBlade[iTurb] - 1;
...
//                          std::cout << "Node " << iNode
//                              << " Position = " << cDriver_Input_from_FAST[iTurb].pxVel[iNode]
//                              << " " << cDriver_Input_from_FAST[iTurb].pyVel[iNode]
//                              << " " << cDriver_Input_from_FAST[iTurb].pzVel[iNode]
//                              << " " << std::endl ;
//                  	 }
//                  }
                }
...
void VTS::getApproxHubPos(std::vector<double> & currentCoords, int iTurbGlob)
{
...
void OpenFAST::getHubPos(std::vector<double> & currentCoords, int iTurbGlob)
{
...
void OpenFAST::getHubShftDir(std::vector<double> & hubShftVec, int iTurbGlob)
{
...
void OpenFAST::getVelNodeCoordinates(std::vector<double> & currentCoords, int iNode, int iTurbGlob)
{
...
void OpenFAST::getForceNodeCoordinates(std::vector<double> & currentCoords, int iNode, int iTurbGlob)
{
...
void OpenFAST::getForce(std::vector<double> & currentForce, int iNode, int iTurbGlob)
{
...
double OpenFAST::getChord(int iNode, int iTurbGlob)
{
...
void OpenFAST::setVelocity(std::vector<double> & currentVelocity, int iNode, int iTurbGlob)
{
...
void OpenFAST::setVelocityForceNode(std::vector<double> & currentVelocity, int iNode, int iTurbGlob)
{
...
void OpenFAST::interpolateVel_ForceToVelNodes()
{
...
void OpenFAST::computeTorqueThrust(int iTurbGlob, std::vector<double> & torque, std::vector<double> & thrust)
{
...
herr_t OpenFAST::closeVelocityDataFile(int nt_global, hid_t velDataFile) {
...
void OpenFAST::writeVelocityData(hid_t h5File, int iTurb, int iTimestep, OpFM_InputType_t iData, OpFM_OutputType_t oData) {
